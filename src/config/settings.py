...
class Settings(BaseSettings):
    ...
    proxy_post_start_service: Optional[str] = Field(default=None, description="Proxy post start service")
    proxy_get_proxies: Optional[str] = Field(default=None, description="Proxy get proxies")
